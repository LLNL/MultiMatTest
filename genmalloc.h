...
#define genvectorfree(var) (genvectorfree_p(var, __FILE__, __LINE__))
...
#define genmatrixfree(var) (genmatrixfree_p(var, __FILE__, __LINE__))
#define gentrimatrixfree(var) (gentrimatrixfree_p(var, __FILE__, __LINE__))
...
#define genmem_free_all() (genmem_free_all_p(__FILE__, __LINE__))
